...
void GYRO_init(I3G4250D_t *gyro) {
	gyro->CS_pin =  NCS_MEMS_SPI_Pin;
	gyro->CS_port = NCS_MEMS_SPI_GPIO_Port;
	gyro->spi_handler = &hspi5;
    GYRO_write_reg(gyro, I3G_CTRL_REG1, 0x9F);
//  GYRO_read_reg(gyro, I3G_CTRL_REG4);
}
